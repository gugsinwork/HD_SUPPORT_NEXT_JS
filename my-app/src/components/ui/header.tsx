...
export default function Header(){
    ...
    return(
        <div className={`${darkMode && "dark"}`} >
            ...
            <header className="w-[80%] border-2  h-[60px] items-center rounded-[20px] mt-5 justify-around  p-[35px] flex dark:border-neutral-950 bg-neutral-950 dark:bg-slate-50">
                ...
                <div className="text-slate-50 dark:text-neutral-950 flex items-center">
                    <a className='hover:underline' href="">Dashboard</a>
                    <a className='hover:underline' href="">Sobre nós</a>
